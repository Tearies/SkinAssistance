...
// **********************************************************************************************************
// FileName:  MessageWeakActionGeneric.cs
// Author:     Teries
...
namespace SkinAssistance.Core.ICommands.Helper
{
    ...
    public class MessageWeakAction<T> : MessageWeakAction, IExecuteWithObject
    {
        #region Fields
        ...
        public MessageWeakAction(Action<T> action)
        ...
        /// <param name="action">The action that will be associated to this instance.</param>
        public MessageWeakAction(object target, Action<T> action)
        {
